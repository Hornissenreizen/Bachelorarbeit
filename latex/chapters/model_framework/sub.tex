...
\section{Model Framework}
    ...
    \begin{definition}
        We define $i_{S_n}(\tau)$ (, $I_{S_n}(\tau)$) to be the minimal (, maximal) mutual information between any two variables of $S_n$ with distance $\tau$. Formally, let $X_t, X_{t + \tau}$ be random variables with distributions defined by $S_n$. Then:
        \vspace{-1em}
        \begin{itemize}
