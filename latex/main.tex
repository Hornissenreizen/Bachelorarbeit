...
\newpage
\subfile{chapters/markov_chains_exponential_decay/sub.tex}

\newpage
\subfile{chapters/regular_grammar/sub.tex}

\newpage
\subfile{chapters/tensor_networks/sub.tex}

\newpage
\subfile{chapters/tree_tensor_networks/sub.tex}

\appendix
\newpage
\subfile{chapters/markov_chains_introduction/sub.tex}

\newpage
\subfile{chapters/information_theory/sub.tex}
\end{document}